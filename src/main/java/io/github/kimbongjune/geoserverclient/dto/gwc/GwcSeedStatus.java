 ...
 * 5-element long array: {@code [tilesDone, tilesTotal, pendingCount, taskId, taskState]}.</p>
 *
 * <p>taskState: -2=UNSET, -1=DEAD, 0=PENDING, 1=RUNNING, 2=DONE</p>
 */
...
public class GwcSeedStatus {
    ...
    /** Parsed view of a single seed task row. */
    public static class Task {
        public final long tilesDone, tilesTotal, pendingCount, taskId, taskState;
    ...
    public boolean equals(Object o) {
        ...
        if (tasks.size() != that.tasks.size()) return false;
        for (int i = 0; i < tasks.size(); i++) {
            if (!Arrays.equals(tasks.get(i), that.tasks.get(i))) return false;
        }
        return true;
    }
