...
public class LayerSummary {
    ...
    /** Constructs an empty {@code LayerSummary} for deserialization. */
    public LayerSummary() {}

    /** @return the layer name (e.g. {@code "ws:layerName"} in global listings) */
    public String getName() {
        return name;
    }
    /** @return the href to the layer detail resource */
